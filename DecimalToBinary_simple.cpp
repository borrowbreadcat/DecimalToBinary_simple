...
void splash()
{
	...
	cout << "\nWrite your base-10 integers (no decimal points!) under 257, and I'll convert them to 8-bit binary:\n";
}
...
int decToBin(int num)
{
	...
	while ( binPlaceVal >= 1 )
	{
		if ((num > 256) || (num < 0))
		{
			cout << "Try a number from 0 to 256. Those are the constraints of an 8-digit binary number.";
			return 0;
		}
		if (num >= binPlaceVal)
		{
